...
if(empty($_SESSION['admin_session'])) {
    ...
    exit; // Added to prevent further execution of the script
}
...
if (isset($_GET['delete_id'])) {
    ...
    if (mysqli_affected_rows($conn) > 0) {
        header('location: subject_list.php'); // Redirect after successful deletion
        exit; // Added to prevent further execution of the script
    }
}
...
<div class="wrapper">
	<div class="footer">
		 <div class="copy">
			<p class="w3-link">E-Learning | &copy; 2024</p>
		</div>
	</div>
</div>
<div class="clear"></div>
